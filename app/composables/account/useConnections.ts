...
import type { Connection, Provider } from '../../types/account'
...
export const useConnections = () => {
  ...
  const mockProviders: Provider[] = [
    { id: 'microsoft', name: 'Microsoft 365', type: 'sso', description: 'Connect with Microsoft Azure AD', icon: 'mdi:microsoft', color: 'blue' },
    { id: 'slack', name: 'Slack', type: 'integration', description: 'Connect your Slack workspace', icon: 'mdi:slack', color: 'purple' },
    { id: 'github', name: 'GitHub', type: 'integration', description: 'Connect your GitHub account', icon: 'mdi:github', color: 'gray' },
    { id: 'notion', name: 'Notion', type: 'integration', description: 'Sync with Notion workspace', icon: 'simple-icons:notion', color: 'black' }
  ]
