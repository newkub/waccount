        ...
        <div class="flex items-start">
          <div class="flex-shrink-0">
            <i
              :class="[
                'text-xl',
                isSuccess ? 'i-mdi-check-circle text-green-500' : 'i-mdi-alert-circle text-red-500',
              ]"
            ></i>
          </div>
          <div class="ml-3 w-0 flex-1 pt-0.5">
            <p :class="['text-sm font-medium', isSuccess ? 'text-green-800 dark:text-green-100' : 'text-red-800 dark:text-red-100']">
              {{ isSuccess ? 'Success' : 'Error' }}
            </p>
            <p :class="['mt-1 text-sm', isSuccess ? 'text-green-700 dark:text-green-200' : 'text-red-700 dark:text-red-200']">
              {{ message }}
            </p>
          </div>
