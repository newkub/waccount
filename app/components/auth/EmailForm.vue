      ...
      <div class="flex items-center justify-between mb-1">
        ...
        <div class="flex items-center gap-2">
          ...
          <div v-if="mode === 'signin'">
            <NuxtLink to="/auth/reset-password" class="text-xs font-medium text-blue-600 hover:text-blue-500 transition-colors">
              Forgot?
            </NuxtLink>
          </div>
        </div>
      ...
      <div class="relative">
        ...
        >
          ...
          <svg v-else class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M11.83 9L15.29 12.46c.04-.32.07-.64.07-.96 0-1.66-1.34-3-3-3-.32 0-.64.03-.96.07L11.83 9zm7.08-2.32c2.33 2.26 3.68 5.7 2.25 9.32-1.73 4.39-6 7.5-11.16 7.5-1.52 0-2.93-.29-4.26-.84l3.15-3.15c.57.29 1.25.46 1.96.46 2.76 0 5-2.24 5-5 0-.71-.17-1.39-.46-1.96l2.52-2.52zM2 4.27l2.28 2.28.46.46A11.804 11.804 0 001 12c1.73 4.39 6 7.5 11 7.5 2.04 0 3.71-.5 5.25-1.3L19.73 21 21 19.73 3.27 2 2 4.27zM7.53 9.8l1.55 1.55c-.05-.21-.08-.43-.08-.65 0-1.66 1.34-3 3-3 .22 0 .44.03.65.08l1.55-1.55c-.67-.33-1.41-.53-2.2-.53-2.76 0-5 2.24-5 5 0 .79.2 1.53.53 2.15z" fill="currentColor"/>
          </svg>
        </button>
      </div>
    </div>
