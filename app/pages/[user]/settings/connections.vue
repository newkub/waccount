	...
	<div>
		...
		<div class="space-y-6">
			...
			<div class="bg-gray-50 rounded-lg p-6">
				...
				<div v-if="ssoConnections.length === 0" class="text-center py-16 px-6">
					<Icon name="mdi:shield-key-outline" class="w-16 h-16 text-gray-400 mx-auto mb-6" />
					<h3 class="text-xl font-semibold text-gray-800 mb-2">No SSO Connections</h3>
					<p class="text-gray-600 max-w-md mx-auto mb-6">
						Single Sign-On allows you to securely access your account using your organization's identity provider.
					</p>
			...
			<div class="bg-gray-50 rounded-lg p-6">
				...
				<div v-if="integrations.length === 0" class="text-center py-16 px-6">
					<Icon name="mdi:puzzle-outline" class="w-16 h-16 text-gray-400 mx-auto mb-6" />
					<h3 class="text-xl font-semibold text-gray-800 mb-2">No Integrations Connected</h3>
					<p class="text-gray-600 max-w-md mx-auto mb-6">
						Connect your account with third-party services to streamline your workflow and sync data automatically.
					</p>
					<button class="px-5 py-2.5 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors font-medium">
						Browse Integrations
					</button>
