...
import type { Subscription, Invoice, Usage, Plan } from '#shared/types';

const mockPlans: Plan[] = [
    { id: 'basic', name: 'Basic', price: 1999, currency: 'USD', features: ['Up to 10 users', 'Basic analytics', 'Email support'], popular: false },
    { id: 'pro', name: 'Pro', price: 2999, currency: 'USD', features: ['Unlimited users', 'Advanced analytics', 'Priority support', 'Custom integrations'], popular: true },
    { id: 'enterprise', name: 'Enterprise', price: 9999, currency: 'USD', features: ['Everything in Pro', 'Enterprise security', 'Dedicated account manager', 'SLA'], popular: false },
];
