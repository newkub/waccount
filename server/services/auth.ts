        ...
        Effect.map((result) => ({
            user: {
                ...
                name: result.user.firstName
                    ...
                    : result.user.email,
                avatar: result.user.profilePictureUrl ? result.user.profilePictureUrl : undefined,
                emailVerified: result.user.emailVerified,
                role: (result.user as any).role ? (result.user as any).role : undefined,
                isAdmin: (result.user as any).isAdmin ? (result.user as any).isAdmin : undefined,
    ...
    pipe(
        Effect.tryPromise({
            try: async () => {
                ...
                new Error(err?.message || "Failed to verify email"),
        }),
    );
